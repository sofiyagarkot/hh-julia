...
ioup_transformed_prior_color = "cyan"
...
function optimize_rate(rates, problem, dt)
    ...
    p2 = plot(
        rates[.!isnan.(errors)], errors[.!isnan.(errors)], 
        label="IOUP(3), dt = $dt", 
        framestyle=:axes,
        xlabel="rate",
        ylabel="L2 error",
    ...
    display(p2)
    savefig(p2, "./visuals/IOUP/rate_per_dt/dt-$dt.png")
...
errors_ioup = []
rates_optimal = [ -239.3939393939394,
                    -69.6969696969697,
                    -3.0303030303030303,
                    3.0303030303030303,
                    3.0303030303030303,
