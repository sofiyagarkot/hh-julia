...
for l in lengthscales
        push!(priors, ProbNumDiffEq.Matern(num_derivatives, l))
end
   
names = []
for l in lengthscales
    push!(names, "Matern($num_derivatives, $l)")
end

ylims_ = []
push!(ylims_, (-10^-4,10^-4))
push!(ylims_, (-0.1,0.1))
push!(ylims_, (-1,1))
push!(ylims_, (-300,300))
...
savefig("./visuals/Matern/Matern-priors-lengthscales.png")
