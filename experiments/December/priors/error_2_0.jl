...
p1 = plot(sol_matern3.t, errors_matern3[1], ribbon=3stds_matern3[1], label="RosenbrockExpEK, \nMatern (3)", xlabel="t", ylabel="error (V), %", title="Absolute % error (V) with confidence intervals", left_margin = [20mm 0mm], upper_margin = 40px, right_margin = [20mm 0mm])
p2 = plot(sol_matern3.t, errors_matern3[2], ribbon=3stds_matern3[2], label="RosenbrockExpEK, \nMatern (3)", xlabel="t", ylabel="error (m), %", title="Error (m)", left_margin = [20mm 0mm], right_margin = [20mm 0mm])
p3 = plot(sol_matern3.t, errors_matern3[3], ribbon=3stds_matern3[3], label="RosenbrockExpEK, \nMatern (3)", xlabel="t", ylabel="error (n), %", title="Error (n)", left_margin = [20mm 0mm], right_margin = [20mm 0mm])
p4 = plot(sol_matern3.t, errors_matern3[4], ribbon=3stds_matern3[4], label="RosenbrockExpEK, \nMatern (3)", xlabel="t", ylabel="error (h), %", title="Error (h)", left_margin = [20mm 0mm], bottom_margin = 60px, right_margin = [20mm 0mm])

plot!(p1, sol_matern5.t, errors_matern5[1], ribbon=3stds_matern5[1],label="EK1, Matern (3)", xlabel="t")
plot!(p1, sol_ioup3.t, errors_ioup3[1],ribbon=3stds_ioup3[1],label="RosenbrockExpEK, \nIOUP (3)", xlabel="t")
plot!(p1, sol_ioup5.t, errors_ioup5[1],ribbon=3stds_ioup5[1],label="EK1, IOUP (3)", xlabel="t", legend=false)
plot!(p1, sol_iwp3.t, errors_iwp3[1],ribbon=3stds_iwp3[1],label="RosenbrockExpEK, IWP (3)", xlabel="t", legend=false)
plot!(p1, sol_iwp5.t, errors_iwp5[1],ribbon=3stds_iwp5[1],label="EK1, IWP (3)", xlabel="t", legend=false)

plot!(p2, sol_matern5.t, errors_matern5[2], ribbon=3stds_matern5[2],label="EK1, Matern (3)", xlabel="t")
plot!(p2, sol_ioup3.t, errors_ioup3[2], ribbon=3stds_ioup3[2],label="RosenbrockExpEK, \nIOUP (3)", xlabel="t")
plot!(p2, sol_ioup5.t, errors_ioup5[2], ribbon=3stds_ioup5[2],label="EK1, IOUP (3)", xlabel="t", legend=false)
plot!(p2, sol_iwp3.t, errors_iwp3[2], ribbon=3stds_iwp3[2],label="RosenbrockExpEK, IWP (3)", xlabel="t", legend=false)
plot!(p2, sol_iwp5.t, errors_iwp5[2], ribbon=3stds_iwp5[2],label="EK1, IWP (3)", xlabel="t", legend=false)

plot!(p3, sol_matern5.t, errors_matern5[3], ribbon=3stds_matern5[3],xlabel="t")
plot!(p3, sol_ioup3.t, errors_ioup3[3], ribbon=3stds_ioup3[3], xlabel="t")
plot!(p3, sol_ioup5.t, errors_ioup5[3], ribbon=3stds_ioup5[3],xlabel="t", legend=false)
plot!(p3, sol_iwp3.t, errors_iwp3[3], ribbon=3stds_iwp3[3],label="RosenbrockExpEK, IWP (3)", xlabel="t", legend=false)
plot!(p3, sol_iwp5.t, errors_iwp5[3], ribbon=3stds_iwp5[3],label="EK1, IWP (3)", xlabel="t", legend=false)


plot!(p4, sol_matern5.t, errors_matern5[4],  ribbon=3stds_matern5[4],label="EK1, Matern (3)", xlabel="t")
plot!(p4, sol_ioup3.t, errors_ioup3[4],ribbon=3stds_ioup3[4],label="RosenbrockExpEK, \nIOUP (3)", xlabel="t")
plot!(p4, sol_ioup5.t, errors_ioup5[4],  ribbon=3stds_ioup5[4],label="EK1, IOUP (4)", xlabel="t")
plot!(p4, sol_iwp3.t, errors_iwp3[4],   ribbon=3stds_iwp3[4],label="RosenbrockExpEK, IWP (3)", xlabel="t")
plot!(p4, sol_iwp5.t, errors_iwp5[4], ribbon=3stds_iwp5[4],label="EK1, IWP (3)", xlabel="t")
